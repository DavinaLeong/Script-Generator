                        ...
                        <div class="col-lg-10">
                            ...
                            <form id="new_migration_form" class="form-horizontal" method="post" action="<?=site_url('export/new_migration');?>" data-parsley-validate>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" id="script_name" name="script_name" value="<?=set_value('script_name');?>" required maxlength="512" pattern="<?=REGEX_PARSLEY_MIGRATIONS_FILENAME;?>" data-parsley-error-message="<li>Must begin with a Capital Letter.</li><li>Replace spaces with underscores (_).</li>" />
